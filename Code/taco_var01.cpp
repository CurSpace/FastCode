...
*/
	    ...
	    // End here 
            for (int j=0; j<numOutputs; j++) {
                ...
                fornumHiddenNodes(int k=0; k<numHiddenNodes; k++) {
  ...
  double measure = double(2 * numInputs * numHiddenNodes )/ double(netTime);
  cout << numInputs<<","<<numHiddenNodes<<","<<measure<<std::endl;
